    ...
    <div className='container'>
      <form onSubmit={handleSubmit} autoComplete='off'>
        <div className="mb-3">
          ...
          <input type="text" className="form-control" name='name' value={credentials.name} onChange={onChange} autoComplete='off' />
        </div>
        ...
        <div className="mb-3">
          ...
          <input type="text" className="form-control" id="address" name='geolocation' value={credentials.geolocation} onChange={onChange} autoComplete='off' />
        </div>
